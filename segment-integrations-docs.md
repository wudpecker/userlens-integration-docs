...
[Userlens](https://userlens.io/) is your AI CSM twin that spot churn risks, and preps your client meetings & QBRs exactly how you would do it. Userlens combines quantitative data from segment, posthog, etc and qualitative feedback from Intercom, Pylon etc to give you a full picture of how your users are using your products and features.
...
4. Go to the [<Userlens> settings](https://app.userlens.io/settings?tab=integrations&subtab=SEGMENT), find and copy the **API key**.
